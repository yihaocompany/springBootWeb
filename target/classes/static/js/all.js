...
$.ajax({
    ...
    success:function (data) {
        if(data.data !=null){
            ...
            $("#webname").html(newData.webname);
            $("#tec").html(newData.tec);
            $("#copyright").html(newData.copyright);
            $("#beian").html(newData.beian);
            $("#href").attr("href",newData.url);
            $("#href").attr("title",newData.webname);
            $("#solgan").html(newData.solgan);
            $("#solgans").html(newData.solgan);
            $("#solganss").html(newData.solgan);
        }
    },
    error:function () {
    }
